export default function DocsPage() {
  return (
    <>
      <h1 className="text-4xl font-light tracking-tight mb-4">Documentation</h1>
      ...
      <section className="space-y-8">
        <div>
          <h2 className="text-2xl font-medium tracking-tight mb-3">Getting Started</h2>
        ...
        <div>
          <h2 className="text-2xl font-medium tracking-tight mb-3">Security Architecture</h2>
          <div className="p-6 rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/30">
